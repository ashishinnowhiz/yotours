...
class BannerHoliday extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
          ...
          <div className="pt-3">
            ...
            <div className="nav-right">
              <div className="nav-right-padding">
                <h1 className="pt-5">Planning a holiday trip<br /> in India ?</h1>
                <p>A subtext will come up here A subtext will come up here A subtext will come up here.</p>
